...
public class MultipulPhotoActivity2 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.PID = String.valueOf(getIntent().getIntExtra("KEY_PID", 0));
        ...
        Cursor cursor = db.rawQuery("SELECT Photo1,Photo2,Photo3,Photo4 FROM WellInspectionDetail where id=?", new String[]{String.valueOf(this.PID)});
        Log.e("PID  ", this.PID);
        if (cursor.moveToNext()) {
            if (!cursor.isNull(0)) {
                byte[] imgData = cursor.getBlob(cursor.getColumnIndex(feedEntry.Phtot1));
            ...
            if (!cursor.isNull(1)) {
                byte[] imgData2 = cursor.getBlob(cursor.getColumnIndex(feedEntry.Phtot2));
            ...
            switch (i) {
                case 0:
                    ...
                    if (intent != null) {
                        ...
                        values.put(feedEntry.Phtot1, imgData);
                ...
                case 1:
                    ...
                    if (intent2 != null) {
                        ...
                        values.put(feedEntry.Phtot2, imgData2);
                        String[] whereArgs2 = {String.valueOf(this.PID)};
                        db.update("WellInspectionDetail", values, "id=?", whereArgs2);
                        break;
                    } else {
                        break;
                    }
                case 2:
                    ...
                    if (intent3 != null) {
                        byte[] imgData3 = intent3.getByteArrayExtra("CapturedImage");
                        values.put(feedEntry.Phtot3, imgData3);
                        String[] whereArgs3 = {String.valueOf(this.PID)};
                        long c1 = db.update("WellInspectionDetail", values, "id=?", whereArgs3);
                        if (c1 > 0) {
                            Log.e("IMAGEE", "Updated");
                            break;
                        } else {
                ...
                case 3:
                    ...
                    if (intent4 != null) {
                        byte[] imgData4 = intent4.getByteArrayExtra("CapturedImage");
                        values.put(feedEntry.Phtot4, imgData4);
                        String[] whereArgs4 = {String.valueOf(this.PID)};
                        db.update("WellInspectionDetail", values, "id=?", whereArgs4);
                        break;
                    } else {
                        break;
                    }
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("GPS is turned OFF...\nDo U Want Turn On GPS..").setCancelable(false).setPositiveButton("Turn on GPS", new DialogInterface.OnClickListener() { // from class: bih.in.forestdept.activity.MultipulPhotoActivity2.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int id) {
                MultipulPhotoActivity2.this.startActivity(new Intent("android.settings.LOCATION_SOURCE_SETTINGS"));
            }
        }).setNegativeButton("No", new DialogInterface.OnClickListener() { // from class: bih.in.forestdept.activity.MultipulPhotoActivity2.1
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int id) {
                dialog.cancel();
            }
    ...
    public void onBackPressed() {
        if (this.purpose.equalsIgnoreCase("new")) {
            if (this.exitCount < 4) {
                ...
                db.resetWellInspectionUpdatedData(String.valueOf(this.PID));
                finish();
                return;
            }
        }
