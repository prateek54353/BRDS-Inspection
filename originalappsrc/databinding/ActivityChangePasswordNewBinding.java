...
public final class ActivityChangePasswordNewBinding implements ViewBinding {
    ...
    private ActivityChangePasswordNewBinding(RelativeLayout rootView, Button btnProceed, EditText etConfirmPass, EditText etNewPass, FooterBinding footer, HeaderBinding header, LinearLayout llUsername, RelativeLayout main, CardView rlUserInfo, TextView textSlideshow, TextView tvPasswordStrenth, TextView tvUsername) {
    ...
    public static ActivityChangePasswordNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityChangePasswordNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(C0594R.layout.activity_change_password_new, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static ActivityChangePasswordNewBinding bind(View rootView) {
                                ...
                                if (rlUserInfo != null) {
                                    ...
                                    if (textSlideshow != null) {
                                        ...
                                        if (tvPasswordStrenth != null) {
                                            ...
                                            if (tvUsername != null) {
                                                return new ActivityChangePasswordNewBinding((RelativeLayout) rootView, btnProceed, etConfirmPass, etNewPass, binding_footer, binding_header, llUsername, main, rlUserInfo, textSlideshow, tvPasswordStrenth, tvUsername);
                                            }
                                        }
                                    }
                                }
