...
public final class AdaptorPlantationReportBinding implements ViewBinding {
    ...
    public final TextView tvInspectedDate;
    ...
    private AdaptorPlantationReportBinding(LinearLayout rootView, Button btnInspect, Button btnMap, LinearLayout llBtn, LinearLayout llInspectedBy, LinearLayout llMap, LinearLayout sblist, TextView tvAgencyName, TextView tvInspectedDate, TextView tvLatitude, TextView tvLongitude, TextView tvWorkCode, TextView tvWorkName, TextView tvWorkType) {
        ...
        this.tvInspectedDate = tvInspectedDate;
    ...
    public static AdaptorPlantationReportBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AdaptorPlantationReportBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View root = inflater.inflate(C0594R.layout.adaptor_plantation_report, parent, false);
        if (attachToParent) {
            parent.addView(root);
        }
        return bind(root);
    ...
    public static AdaptorPlantationReportBinding bind(View rootView) {
                        ...
                        if (llMap != null) {
                            ...
                            if (sblist != null) {
                                ...
                                if (tvAgencyName != null) {
                                    id = C0594R.id.tv_inspected_date;
                                    TextView tvInspectedDate = (TextView) ViewBindings.findChildViewById(rootView, C0594R.id.tv_inspected_date);
                                    if (tvInspectedDate != null) {
                                            ...
                                            if (tvLongitude != null) {
                                                ...
                                                if (tvWorkCode != null) {
                                                    ...
                                                    if (tvWorkName != null) {
                                                        ...
                                                        if (tvWorkType != null) {
                                                            return new AdaptorPlantationReportBinding((LinearLayout) rootView, btnInspect, btnMap, llBtn, llInspectedBy, llMap, sblist, tvAgencyName, tvInspectedDate, tvLatitude, tvLongitude, tvWorkCode, tvWorkName, tvWorkType);
                                                        }
                                                    }
                                                }
                                            }
